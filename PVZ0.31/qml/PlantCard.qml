            ...
            onClicked: {
                if(canClick){
                    if(gameWindow.plantPrice[index] <= gameWindow.sunNumber){
                        //让上一个被点击的边框隐藏
                        if(gameWindow.lastSelectPlantCard != null){
                            //确保能点
                            if(gameWindow.lastSelectPlantCard.canClick){
                                gameWindow.lastSelectPlantCard.hideBorder()
                            }
                        }
                        ...
                        border.visible = true
                        gameWindow.lastSelectPlantCard = plantCard
